...
export default {
	...
	data() {
		return {
			...
			// 分类菜单
			categoryList: [
				{ id: 1, name: '家具百货', img: '/static/img/category/1.png' },
				{ id: 2, name: '彩妆护肤', img: '/static/img/category/2.png' },
				{ id: 3, name: '饰品系列', img: '/static/img/category/3.png' },
				{ id: 4, name: '季节产品', img: '/static/img/category/4.png' },
				{ id: 5, name: '精美包饰', img: '/static/img/category/5.png' },
				{ id: 6, name: '毛绒玩具', img: '/static/img/category/6.png' },
				{ id: 7, name: '数码配件', img: '/static/img/category/7.png' },
				{ id: 8, name: '文体礼品', img: '/static/img/category/8.png' },
				{ id: 9, name: '文体礼品', img: '/static/img/category/10.png' },
				{ id: 10, name: '休闲零食', img: '/static/img/category/9.png' }
